        ...
        <div class="container-fluid px-0">
          <div class="row no-gutters text align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-12 ftco-animate text-center">
              <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Наші роботи</span></p>
              <h1 class="bread">Наші роботи</h1>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/Screenshot_1.png);">
                </a>
                <div class="text">
                  <h3 class="mb-0">Інтернет магазин</h3>
                </div>
              </div>
            </div>
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/Screenshot_2.png);">
                </a>
                <div class="text">
                  <h3 class="mb-0">Фотограф</h3>
                </div>
              </div>
            </div>
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/work-3.jpg);">
                </a>
                <div class="text">
                  <h3 class="mb-0">Дизайнер інтер'єру</h3>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/work-4.jpg);">
                </a>
                <div class="text">
            ...
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/work-5.jpg);">
                </a>
                <div class="text">
                  <h3 class="mb-0">Викладач гри на гітарі</h3>
                </div>
              </div>
            </div>
            <div class="col-md-4 ftco-animate">
              <div class="project">
                <a href="#" class="img d-flex align-items-center justify-content-center" style="background-image:url(images/work-6.jpg);">
                </a>
                <div class="text">
                  <h3 class="mb-0">Школа мистецтв</h3>
                </div>
              </div>
            </div>
          </div>
